...
class RelationBottomSheet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _RelationBottomSheetState();

}

class _RelationBottomSheetState extends State<RelationBottomSheet> with SingleTickerProviderStateMixin {
...
final List<Event> events = [
  Event('neris.jpg', 'Neris Baskan', '4.20-30'),
  Event('john.jpg', 'John Doe', '4.20-30'),
];
